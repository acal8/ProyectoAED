...
# front matter
simplesummary: |
  Análisis de la tasa de mortalidad en España por comunidades autónomas y su relación con la esperanza de vida, la inversión en sanidad y la renta media por unidad de consumo.
abstract: |
...
library(pacman)
packages <- c("tidyverse", "knitr", "ggplot2", "dplyr", "datasets", "RColorBrewer", "latex2exp", "readr", "lubridate", "magrittr", "writexl", "xlsx")
